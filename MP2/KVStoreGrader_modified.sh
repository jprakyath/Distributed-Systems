...
do
	...
	then
		...
		echo read_op_test1_key = $read_op_test1_key
		echo read_op_test1_value = $read_op_test1_value
	elif [ ${cnt} -eq 2 ]
	then
	...
	then
		...
		echo read_op_test4_time = $read_op_test4_time
		echo read_op_test4_key = $read_op_test4_key
		echo read_op_test4_value = $read_op_test4_value
	elif [ ${cnt} -eq 6 ]
	then
